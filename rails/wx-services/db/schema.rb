...
ActiveRecord::Schema.define(:version => 20121225131217) do
  ...
  add_index "alerts", ["date"], :name => "index_alerts_on_date"
  add_index "alerts", ["expires"], :name => "index_alerts_on_expires"
  add_index "alerts", ["location"], :name => "index_alerts_on_location"
